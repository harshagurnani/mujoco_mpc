...
#ifndef MJPC_TASKS_FRUITFLY_TRACKING_TASK_H_
#define MJPC_TASKS_FRUITFLY_TRACKING_TASK_H_
...
class FlyTracking : public Task {
 public:
  class ResidualFn : public mjpc::BaseResidualFn {
   public:
    explicit ResidualFn(const FlyTracking* task, int current_mode = 0,
   ...
   private:
    friend class FlyTracking;
    int current_mode_;
    double reference_time_;
  };

  FlyTracking() : residual_(this) {}
