...
BASE_MODEL = 'drosophila_defaults2.xml'
FLY_MODEL = 'drosophila_fused2.xml'  # Pre-generated by fuse_fruitfly.py

FINAL_MODEL = 'fruitfly_force.xml'  # Output file of this script.
...
def main(argv: Sequence[str]):
  ...
  with open(os.path.join(ASSET_DIR, FINAL_MODEL), 'wb') as f:
    f.write(xml_string)
